...
export default class Home extends Component {
        ...
        render() {
          ...
          In this project we will attempt to create a balancing game which will communicate with the dev kit, and light up LEDs and play a tone more rapidly the more unbalanced the unit gets. We will have a MPU to measure the angle of the board. The gyroscope MPU will be connected via I2C, and the LEDs will be connected via GPIO. 
          </div>
